...
let stripe = require("stripe")("sk_test_fZLJAGvJJFlDaTEffCVEjChj");
...
module.exports = {
  ...
  add: async (body) => {
    ...
    console.log(body);
    var amount;
    if(body.plan_name=='Standard')
      amount=500;
    if(body.plan_name=='Advanced')
      amount=900;
    ...
    const relations = _.pick(body, Payment.associations.map(ast => ast.alias));
    const data = _.omit(body, Payment.associations.map(ast => ast.alias));
